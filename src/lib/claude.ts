...
**캐릭터 교체(태그)**
- 벤치 캐릭터 HP가 지금 활성 캐릭터보다 확실히 높다면, 특히 HP가 낮아 다음 공격에 죽을 수 있는
  상황에서는 태그도 적극적으로 고려하세요. 태그는 SETUP(내 턴)에 즉시 적용되어, 이번 턴 들어오는
  피해를 새 캐릭터가 받게 됩니다 — 위기의 캐릭터를 안전하게 빼는 수단입니다.
