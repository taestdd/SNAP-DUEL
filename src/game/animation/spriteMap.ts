...
const DEFAULT_POSES: Record<FighterPose, PoseEntry> = {
  ...
  hit:                { frames: [30, 31],                     fps: 8, hold: true  },
  hit_weak:           { frames: [30, 31],                     fps: 8,  hold: true  },
  hit_strong:         { frames: [32, 33],                     fps: 8, hold: true  },
  hit_aerial:         { frames: [34, 35],                     fps: 8,  hold: true  },
  ...
  attack_dragon_kick: { frames: [15, 16, 17, 18, 19, 20, 21], fps: 16, hold: true  },
  attack_rising_punch:{ frames: [22, 23, 24, 25, 26],         fps: 12, hold: true  },
  attack_hadouken:    { frames: [12, 13, 14],                 fps: 10, hold: true  },
